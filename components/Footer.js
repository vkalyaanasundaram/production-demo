...
import { FooterNav, FooterContent } from "../styles/Home.module.css";
            ...
            <footer className="text-gray-600 body-font">
              ...
              <div className="bg-gray-100">
                <div className="container">
                  ...
                  | Loans made in California are issued by Strategic Funding
                  Source, Inc. dba Kapitus, pursuant to California Finance
                  Lenders License No. 603-G807. <br />{" "}
